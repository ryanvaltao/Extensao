...
#(SIDRA_UF, ATLAS_ UF,  SINASC_UF, SIM_UF e SINISA_UF), 
#sendo que as variáveis deverão seguir a ordem

# ANO, NIVEL, CODMUNRES (uma única vez), variáveis do SIDRA, do ATLAS, do SINASC, 
#do SIM e da SINISA. No merge deve constar qualquer município que esteja em pelo menos um dos bancos
